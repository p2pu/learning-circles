...
const tinymceApiKey = element.dataset.tinymceApiKey
const learningCircle = window.lc

ReactDOM.render(<CreateLearningCirclePage user={user} learningCircle={learningCircle} tinymceApiKey={tinymceApiKey} />, element)