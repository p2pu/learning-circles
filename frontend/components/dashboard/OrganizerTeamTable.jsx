...
export default class OrganizerTeamTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      learningCircles: [],
  ...
  populateResources = (params={}) => {
    ...
    const defaultParams = { limit: this.state.limit, offset: this.state.offset, user: true, draft: true, scope: "upcoming" }
