...
from studygroups.views import StudyGroupCourseRating
...
urlpatterns = [
    ...
    url(r'^studygroup/(?P<study_group_id>[\w-]+)/course_rating/$', StudyGroupCourseRating.as_view(), name='studygroups_course_rating'),
