...
urlpatterns = [
    ...
    url(r'^studygroup/(?P<study_group_id>[\w-]+)/facilitator_feedback/done$', TemplateView.as_view(template_name='studygroups/facilitator_feedback_done.html'), name='studygroups_facilitator_feedback_done'),
