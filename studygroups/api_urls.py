...
urlpatterns = [
    ...
    url(r'^city/complete/$', views.city_complete, name='api_learningcircles_city_complete'),
    url(r'^city/(?P<place_id>[\d]+)$', views.city_info, name='api_learningcircles_city_info'),
